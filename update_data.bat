...
copy /Y "..\ARM64\Release Service\Server.pdb" "pdbs\arm64\urbackupsrv.pdb"
copy /Y "..\ARM64\Release Service\Server.exe" "data_arm64\urbackupsrv.exe"
copy /Y "..\ARM64\Release Service\Server.exe" "data_arm64\UrBackupClientBackend.exe"
copy /Y "..\ARM64\Release Service\Server.pdb" "pdbs\arm64\UrBackupClientBackend.pdb"
copy /Y "..\ARM64\release\urbackupclient.dll" "data_arm64\urbackup.dll"
copy /Y "..\ARM64\release\urbackupclient.pdb" "pdbs\arm64\urbackup.pdb"
copy /Y "..\ARM64\release\cryptoplugin.dll" "data_arm64\cryptoplugin.dll"
copy /Y "..\ARM64\release\cryptoplugin.pdb" "pdbs\arm64\cryptoplugin.pdb"
copy /Y "..\ARM64\release\fileservplugin.dll" "data_arm64\fileservplugin.dll"
copy /Y "..\ARM64\release\fileservplugin.pdb" "pdbs\arm64\fileservplugin.pdb"
copy /Y "..\ARM64\release\fsimageplugin.dll" "data_arm64\fsimageplugin.dll"
copy /Y "..\ARM64\release\fsimageplugin.pdb" "pdbs\arm64\fsimageplugin.pdb"
copy /Y "ARM64\Release\UrBackupClientGUI.exe" "data_arm64\UrBackupClient.exe"
copy /Y "ARM64\Release\UrBackupClientGUI.pdb" "pdbs\arm64\UrBackupClient.pdb"
copy /Y "..\ARM64\release\sysvol_test.exe" "data_arm64\sysvol_test.exe"
copy /Y "..\ARM64\release\clientctl.exe" "data_arm64\UrBackupClient_cmd.exe"
copy /Y "..\deps\misc\KillProc_x86_64.exe" "data_arm64\KillProc.exe"

...
void Settings::OnOkClick( wxCommandEvent& event )
{
	...
	s_data += wxString("internet_server=")+ internet_server.ToUTF8() + "\n";
	s_data += std::string("internet_server_port=") + nconvert(l_internet_server_port) + "\n";
	s_data += wxString("internet_server_proxy=") + internet_server_proxy.ToUTF8() + "\n";
	s_data += wxString("internet_authkey=") + internet_authkey.ToUTF8() + "\n";
	s_data += wxString("computername=") + computername.ToUTF8() + "\n";
